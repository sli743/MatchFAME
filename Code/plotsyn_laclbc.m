clear all;
load('./Data/data_laclbc - Copy (4).mat');
...
%             'mean(err_' alglist2{alg} '_' num2str(n_node_corr) ');']);
        ...
        evalc(['mean_F_' alglist2{alg} '_' num2str(n_node_corr) ' = ' ...
            'nanmean(F_' alglist2{alg} '_' num2str(n_node_corr) ');']);
        evalc(['std_F_' alglist2{alg} '_' num2str(n_node_corr) ' = ' ...
...
set(gca,'FontSize',20);
saveas(gcf,'plotsyn_laclbc_error.eps','epsc');
...
saveas(gcf,'plotsyn_laclbc_numM.eps','epsc');
...
% objhl = findobj(objh, 'type', 'Line');set(objhl, 'Markersize', 20, 'LineWidth', 3);
set(gca,'FontSize',20);
saveas(gcf,'plotsyn_laclbc_precision.eps','epsc');
...
% objhl = findobj(objh, 'type', 'Line');set(objhl, 'Markersize', 20, 'LineWidth', 3);
set(gca,'FontSize',20);
saveas(gcf,'plotsyn_laclbc_recall.eps','epsc');
...
% objhl = findobj(objh, 'type', 'Line');set(objhl, 'Markersize', 20, 'LineWidth', 3);
set(gca,'FontSize',20);
saveas(gcf,'plotsyn_laclbc_F.eps','epsc');